...
Python backend development and data handling with Pandas.

MySQL database design, querying, and integration.

Building interactive UI with Streamlit.

Data visualization using Matplotlib.

Implementing security with password hashing.

Managing and analyzing query data efficiently
...
![Untitled (1)](https://github.com/user-attachments/assets/9b3fa60f-7a61-4a2d-bee1-447c8787a69f)
